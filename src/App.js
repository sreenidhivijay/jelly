    ...
    <UserProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/campaigns/midnight-high-tea" element={<MidnightHighTeaDrop />} />
          <Route path="/signup/business/content-types" element={<ContentTypeSelectionPage />} />
          <Route path="/signup/business/posting-frequency" element={<PostingFrequencyPage />} />
          <Route path="/signup/business/how-it-works" element={<HowItWorksPage />} />
          ...
          <Route path="/creator-appointments" element={<CreatorAppointmentsPage />} />
